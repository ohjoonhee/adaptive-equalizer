...
class TFCB_CPq(nn.Module):
    def __init__(self, num_channel=64, attn_mask=None):
        ...
        self.time_conformer = ConformerBlock2(
            dim=num_channel,
        ...
        self.freq_conformer = ConformerBlock2(
            dim=num_channel,
            dim_head=num_channel // 4,
            heads=4,
            conv_kernel_size=31,
        ...
        self.mhsa = nn.MultiheadAttention(
            embed_dim=num_channel, num_heads=4, batch_first=True
        )
    ...
    def forward(self, x_in):
        ...
        x_o = (
            self.time_conformer.forward(x_t, q_given=x_tq, mask=self.attn_mask) + x_t
        )  ## have to mask!!
